    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-500">{initializing ? "Menginisialisasi workshop..." : "Memuat data..."}</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700">
      ...
      <div className="pt-12 pb-8 px-4 text-center">
        ...
        <div className="flex items-center justify-center gap-6 mt-4 text-sm text-blue-200">
          ...
          <span>💰 Max: {formatRupiah(settings?.maxPengeluaran ?? 0)}</span>
          <span>🏆 Target: {formatRupiah(settings?.jumlahPendapatan ?? 0)}</span>
        </div>
      </div>
        ...
        {!showAdminLogin ? (
          <>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 mb-4">
              <div className="flex items-center gap-2 mb-5">
                ...
                <h2 className="text-lg font-semibold text-slate-800">Pilih Tim Anda</h2>
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6">
            <div className="flex items-center gap-2 mb-5">
              ...
              <h2 className="text-lg font-semibold text-slate-800">Login Penyelenggara</h2>
            </div>
            <form onSubmit={handleAdminLogin} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  autoFocus
                />
                {adminError && <p className="text-red-600 text-xs mt-1">{adminError}</p>}
              </div>
              <div className="flex gap-3">
                <button type="submit" className="btn-primary flex-1">Masuk</button>
                <button
                  type="button"
                  onClick={() => { setShowAdminLogin(false); setAdminError(""); setAdminPw(""); }}
